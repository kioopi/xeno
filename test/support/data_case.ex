defmodule Xeno.DataCase do
  ...
  by setting `use Xeno.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(Xeno.Repo, shared: not tags[:async])
